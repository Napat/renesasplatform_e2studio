...
#define RSA_API_VERSION_MINOR (01)

/** Return RSA modulus size in bytes from the specified RSA modulus size in bits */
#define RSA_MODULUS_SIZE_BYTES(RSA_SIZE_BITS)                    ((RSA_SIZE_BITS)/8)
...
#endif /* defined(BSP_MCU_GROUP_S7G2) || defined(BSP_MCU_GROUP_S5D9) || defined(BSP_MCU_GROUP_S5D5)*/
