...
/* Define default parameters for the Cortex-M0+ build for smaller footprint.  */
...
#if defined(TX_VFP_ENABLE) && defined(TX_ENABLE_IAR_LIBRARY_SUPPORT)
#define TX_THREAD_EXTENSION_2                   ULONG       tx_thread_vfp_stack_frame; \
                                                VOID        *tx_thread_iar_tls_pointer;          
#elif defined(TX_VFP_ENABLE)
#define TX_THREAD_EXTENSION_2                   ULONG       tx_thread_vfp_stack_frame;
#elif defined(TX_ENABLE_IAR_LIBRARY_SUPPORT)
...
CHAR                            _tx_version_id[] = 
                                    "Copyright (c) 1996-2016 Express Logic Inc. * ThreadX Synergy/IAR Version G5.7.5.1 SN: 4154-280-5000 *";
#else
