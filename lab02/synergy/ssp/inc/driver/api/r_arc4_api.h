 ...
 * Macro definitions
 **********************************************************************************************************************/
#define ARC4_API_VERSION_MAJOR (01)
#define ARC4_API_VERSION_MINOR (00)

#define DRV_ARC4_CONTEXT_BUFFER_SIZE (66)
...
typedef struct st_arc4_api
{
     ...
     * @param[in]     p_cfg  pointer to control structure for the ARC4 configuration. All elemenets of this structure
     *                       must be set by user.
     *
     */
